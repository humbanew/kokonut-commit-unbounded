...
See how [a minor change](#examples) to your commit message style can make a
difference.
...
> [!Note] This cheatsheet is opinionated, however it does not violate the
> specification of [conventional commits](https://www.conventionalcommits.org/)
...
- Breaking changes **should** be described in the
  [commit footer section](#footer), if the [commit description](#description)
  isn't sufficiently informative
...
- I case of breaking changes also see
...
The `footer` should contain issue references and informations about **Breaking
Changes**

- The footer is an **optional** part, except if the commit introduce breaking
  changes
- _Optionally_ reference issue identifiers (e.g., `Closes #123`,
  `Fixes JIRA-456`)
...
- **If** your next release contains commit with...
    ...
    - **API relevant changes** (`feat` or `fix`) incremented the **minor
      version**
...
* ⚠ make `.git/hooks/pre-receive` executable (unix:
...
- http://karma-runner.github.io/1.0/dev/git-commit-msg.html <br>
