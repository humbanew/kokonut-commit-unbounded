...
if (args.includes('--help') || args.includes('-h')) {
    console.log('Kokonut Commit CLI\nUsage: kokonut-commit config set|get|list | kokonut-commit setup | kokonut-commit models | kokonut-commit hook set|unset [--global] [--usr <path>]');
    process.exit(0);
}
if (args.length === 0) {
    console.log('Kokonut Commit CLI\nUsage: kokonut-commit config set|get|list | kokonut-commit setup | kokonut-commit models | kokonut-commit hook set|unset [--global] [--usr <path>]');
